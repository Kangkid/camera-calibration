...
/********      第一个参数Image，传入拍摄的棋盘图Mat图像；(imageInput)      
第二个参数patternSize，每个棋盘图上内角点的行列数，；(board_size)      
第三个参数corners，用于存储检测到的内角点图像坐标位置：vector<Point2f> image_points_buf;(image_points_buf)      
...
Mat R = Mat::eye(3, 3, CV_32F);    string imageFileName;    
